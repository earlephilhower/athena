...
#define STRING_CONFIG_H_AUTHOR "Earle F. Philhower, III" // Who made the changes.
...
// Should be 80.0 or 80.8
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 90.9 }
...
#define NOZZLE_TO_PROBE_OFFSET { 27, 15, -1.9 }
